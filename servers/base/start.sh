...
./oDFe.ded.x64 +set fs_homepath . +set fs_cdpath ./maps +set net_enabled 1 +set net_port 27960 +set rs_server_id $RS_SV_ID +set com_hunkmegs 256 +set sv_pure 0 +set sv_levelTimeReset 1 +set fs_game defrag +set dedicated 2 +set vm_game 0 +set ttycon_ansicolor 1 +set bot_enable 0 +exec cfgs/mixed.cfg
