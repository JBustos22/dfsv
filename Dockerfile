...
RUN wget http://security.ubuntu.com/ubuntu/pool/main/libx/libxml2/libxml2_2.9.4+dfsg1-6.1ubuntu1.9_i386.deb
RUN dpkg -i libxml2_2.9.4+dfsg1-6.1ubuntu1.9_i386.deb
